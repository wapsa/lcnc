...
public class SearchInRotatedSortedArray {
	...
	public static void main(String[] args) {
		...
		System.out.println(searchPractice(new int[] { 4, 5, 6, 7, 0, 1, 2 }, 0));
		System.out.println(searchPractice(new int[] { 4, 5, 6, 7, 0, 1, 2 }, 3));
		System.out.println(searchPractice(new int[] { 1 }, 0));
	}

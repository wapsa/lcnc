...
public class Subsets2 {
	...
	public static void main(String[] args) {
		...
		System.out.println(subsetsWithDupPractice(new int[] { 1, 2, 2 }));
		System.out.println(subsetsWithDupPractice(new int[] { 0 }));
	}

	private static List<List<Integer>> subsetsWithDupPractice(int[] nums) {

...
/**
 * 88. Merge Sorted Array Easy Topics Companies Hint You are given two integer
 * arrays nums1 and nums2, sorted in non-decreasing order, and two integers m
 ...
 * merge is [1].
 * 
 * Example3: Input: nums1 = [0], m = 0, nums2 = [1], n = 1 Output: [1]
...
public class MergeSortedArray {
	...
	public static void main(String[] args) {
		...
		System.out.println(Arrays.toString(mergePractice(new int[] { 1, 2, 3, 0, 0, 0 }, 3, new int[] { 2, 5, 6 }, 3)));
		System.out.println(Arrays.toString(mergePractice(new int[] { 1 }, 1, new int[] {}, 0)));
		System.out.println(Arrays.toString(mergePractice(new int[] { 0 }, 0, new int[] { 1 }, 1)));
	}

	private static int[] mergePractice(int[] nums1, int m, int[] nums2, int n) {
		return new int[0];
	}
